...
<screen name="KurdRTLAbout" position="center,center" size="960,600" title="About AIO Image RTLFixer">
    ...
    <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/KurdRTLFixer/icon/key_red.png" position="400,525" size="40,40" zPosition="1" alphatest="blend"/>
    <widget name="key_red" position="450,525" size="200,40" font="Regular;28" halign="left" valign="center" foregroundColor="#111111" transparent="1"/>
</screen>
"""
        self["title"] = Label("AIO Image RTLFixer v1.0.0-r0")
